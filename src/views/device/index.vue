        ...
        <div ref="dirList" class="device-list__left" :style="`width: ${dirDrag.width}px`">
          <div class="dir-list" :style="`width: ${dirDrag.width}px`">
            <div class="dir-list__tools">
              ...
              <el-tooltip v-if="!isVGroup && checkPermission(['AdminDevice'])" class="item" effect="dark" content="添加目录" placement="top" :open-delay="300">
            ...
            <div v-loading="loading.dir" class="dir-list__tree device-list__max-height" :style="{height: `${maxHeight}px`}">
              ...
              >
                ...
                >
                  ...
                  <div v-if="data.type === 'dir' && !isVGroup && checkPermission(['AdminDevice'])" class="tools">
