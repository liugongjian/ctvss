  ...
  <div ref="listWrap" class="device-list__container">
    ...
    <div ref="filterWrap" class="filter-container clearfix">
      <div class="filter-container__left">
        ...
        <el-dropdown v-if="!isVGroup && checkPermission(['ivs:UpdateDevice', 'ivs:DeleteDevice'], selectedDeviceList) && isAllowedDelete" placement="bottom" @command="handleBatch">
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item v-if="checkPermission(['ivs:DeleteDevice'], selectedDeviceList)" command="delete">删除</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
