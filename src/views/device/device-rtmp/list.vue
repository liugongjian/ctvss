  ...
  <div class="device-list__container">
    ...
    <div class="filter-container clearfix">
      <div class="filter-container__left">
        <el-button v-if="checkPermission(['*']) && (isDir || deviceInfo)" type="primary" @click="goToCreate">{{ isNVR ? '添加子设备' : '添加设备' }}</el-button>
        ...
        <el-button v-if="checkPermission(['*']) && (isDir || deviceInfo)" @click="exportTemplate">下载模板</el-button>
