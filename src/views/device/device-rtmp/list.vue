  ...
  <div class="device-list__container">
    ...
    <div class="filter-container clearfix">
      <div class="filter-container__left">
        <el-button v-if="!isVGroup && checkPermission(['*']) && (isDir || deviceInfo)" type="primary" @click="goToCreate">{{ isNVR ? '添加子设备' : '添加设备' }}</el-button>
        ...
        <el-upload
          v-if="!isVGroup && checkPermission(['*']) && (isDir || deviceInfo)"
          ref="excelUpload"
          action="#"
        ...
        <el-button v-if="!isVGroup && checkPermission(['*']) && (isDir || deviceInfo)" @click="exportTemplate">下载模板</el-button>
        <el-dropdown v-if="!isVGroup && checkPermission(['*'])" placement="bottom" @command="handleBatch">
          ...
          <template slot-scope="scope">
            ...
            <el-dropdown @command="handleMore">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item v-if="!isVGroup && checkPermission(['*'])" :command="{type: 'delete', device: scope.row}">删除</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </template>
        </el-table-column>
