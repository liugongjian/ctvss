    ...
    <div v-loading="loading.info" class="detail-wrap">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane v-if="info && info.deviceType === 'ipc' && checkPermission(['ivs:GetCloudRecord'], actions)" label="录像回放" name="replay">
          <detail-replay v-if="activeName==='replay'" :device-id="deviceId" :in-protocol="inProtocol" :info="info" :permission="actions" :device-name="info.deviceName" :lock-permission="checkPermission(['ivs:LockCloudRecord'], actions)" />
        </el-tab-pane>
