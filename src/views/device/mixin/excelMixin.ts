...
export default class ExcelMixin extends Vue {
  ...
  private columnsTemplate: any = {
    gb28181: {
      template: [
        ...
        { header: 'GB28181账号', key: 'userName', width: 16 },
    ...
    rtsp: {
      template: [
        ...
        { header: '设备IP', key: 'deviceIp', width: 24 },
        { header: '设备域名', key: 'deviceDomain', width: 24 },
        { header: '设备端口', key: 'devicePort', width: 16 },
        { header: '设备通道数量', key: 'channelSize', width: 16 },
  ...
  private gb28181OptionsInit(worksheet: any) {
    ...
    worksheet.dataValidations.add('K2:K9999', this.validation.pullType)
    ...
    //   error: '请检查国标ID格式是否正确'
    // })
    worksheet.dataValidations.add('L2:L9999', this.validation.transPriority)
    worksheet.dataValidations.add('M2:M9999', this.validation.channelSize)
  ...
  private rtspOptionsInit(worksheet: any) {
    ...
    worksheet.dataValidations.add('S2:S9999', this.validation.transPriority)
  ...
  private ehomeOptionsInit(worksheet: any) {
    ...
    worksheet.dataValidations.add('H2:H9999', this.validation.multiStreamSize)
