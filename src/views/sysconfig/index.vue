    ...
    <el-form ref="form" :model="form" :rules="rules">
      <el-tabs v-model="activeName" type="border-card">
        <el-tab-pane label="通用" name="common">
          ...
          <el-form-item prop="nvrName" label-width="240px">
            <template slot="label">
              平台自定义NVR通道名称:
              <el-popover
                placement="top-start"
                ...
                trigger="hover"
                :open-delay="300"
                :content="tips.nvrName"
              >
                <svg-icon slot="reference" class="form-question" name="help" />
              </el-popover>
            </template>
            <el-switch v-model="form.nvrName" active-value="true" inactive-value="false" />
          </el-form-item>
        </el-tab-pane>
...
export default class extends Vue {
  ...
  private tips = {
    ...
    nvrName: '开启该功能，NVR通道重新上线不会覆盖用户自定义的通道名称'
  }
  private cacheForm = {
    screen: 'false',
    replay: 'false',
  ...
  private async submit() {
    ...
    form.validate(async(valid: any) => {
      ...
      try {
        ...
        let keyList = ['screen', 'replay', 'nvrName']
