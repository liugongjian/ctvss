...
export const drawCamera = (markerOptions: markerObject, options) => {
  ...
  let mColor = JSON.parse(markerOptions.appearance).color || '#1e78e0'
  if (mColor === '0') {
    mColor = '#1e78e0'
  }
