      ...
      <div class="device-list" :style="{height: `${maxHeight + 35}px`}" :class="{'device-list--collapsed': !isExpanded, 'device-list--dragging': dirDrag.isDragging}">
        ...
        <div class="device-list__right">
          ...
          <div class="device-list__max-height" :style="{height: `${maxHeight}px`}">
            ...
            <el-dialog title="添加监控点位" :visible.sync="addPositionDialog" class="dialog-text" :before-close="closeDialog">
              <div>
                <h3>是否继承设备中的经纬度</h3>
            ...
            <el-dialog title="添加监控点位" :visible.sync="addNoPositionDialog" class="dialog-text" :before-close="closeDialog">
              <div>
            ...
            <el-dialog title="添加监控点位" :visible.sync="dragAddNoPositionDialog" class="dialog-text" :before-close="closeDialog">
              <div>
