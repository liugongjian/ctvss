<template>
  <div>
    ...
    >
      ...
      >
        <div v-if="['4', '19', '10001', '10016'].includes(type) && location.score !== 0" class="ai-recognation__images__item__mask__text" :class="{'ai-recognation__images__item__mask__text--warning': location.isWarning}">
