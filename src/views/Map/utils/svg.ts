...
export const drawCameraBg = (start) => {
  ...
  return `<svg width="39px" height="67px" viewBox="0 0 39 67" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
        ...
        <filter x="-32.1%" y="-56.3%" width="164.3%" height="212.5%" filterUnits="objectBoundingBox" id="filter-2">
            <feMorphology radius="1" operator="dilate" in="SourceAlpha" result="shadowSpreadOuter1"></feMorphology>
            <feOffset dx="0" dy="0" in="shadowSpreadOuter1" result="shadowOffsetOuter1"></feOffset>
            <feGaussianBlur stdDeviation="0.5" in="shadowOffsetOuter1" result="shadowBlurOuter1"></feGaussianBlur>
            <feColorMatrix values="0 0 0 0 0.8   0 0 0 0 0.8   0 0 0 0 0.8  0 0 0 0.616531906 0" type="matrix" in="shadowBlurOuter1"></feColorMatrix>
        </filter>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g transform="translate(-774.000000, -331.000000)">
            <g id="Group-4" transform="translate(774.000000, 331.000000)">
                <g fill="black" fill-opacity="1">
                    <use filter="url(#filter-2)" xlink:href="#path-1"></use>
                </g>
                <g>
                    <use fill="black" fill-opacity="1" filter="url(#filter-4)" xlink:href="#path-3"></use>
                    <ellipse stroke="#999999" stroke-width="1" stroke-linejoin="square" fill="#D8D8D8" fill-rule="evenodd" cx="19" cy="58" rx="3.5" ry="1.78571429"></ellipse>
                </g>
