...
import { getEhomeCertificateList, deleteEhomeCertificate } from '@vss/device/api/certificate'
...
export default class extends Vue {
  ...
  private async getList() {
    ...
    try {
      const res = await getEhomeCertificateList(params)
