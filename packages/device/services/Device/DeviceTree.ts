...
* @param state.treeSearchResult 搜索结果
*/
const initAdvancedSearch = async function(state: { $route: any, advancedSearchForm: AdvancedSearch, lazy: boolean, loading: any, treeSearchResult: any, deviceTree: any }) {
